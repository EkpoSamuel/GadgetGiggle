    ...
    <!-- start #footer -->
     <footer id="footer" class="bg-dark text-white py-5">
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-12">
              <h4 class="font-rubik font-size-20">Gadget Giggle</h4>
      ...
      <div class="copyright text-center bg-dark text-white py-2">
        <p class="font-rale font-size-14">&copy; Copyrights 2023. Design by <a href="#" class="color-second">Ekpo Samuel.</a></p>
      </div>
    <!-- !start #footer -->
