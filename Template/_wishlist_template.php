                ...
                foreach ($product->getData('wishlist') as $item) :
                    ...
                    $subTotal[] = array_map(function ($item){
                        ...
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="<?php echo $item['item_image'] ?? "./assets/products/1.png" ?>" style="height: 100px;" alt="cart1" class="img-fluid mt-2">
                            </div>
                            <div class="col-sm-8">
                                ...
                                <div class="d-flex">
                                    ...
                                    <a href="#" class="px-2 font-rale font-size-14" style="text-decoration: none;">20,534 ratings</a>
                                </div>
                                <!--  !product rating-->
